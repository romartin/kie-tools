...
@ApplicationScoped
@Named(StunnerRuntimeEditor.EDITOR_ID)
public class StunnerRuntimeEditorActivity extends AbstractActivity implements EditorActivity {

    @Inject
    private StunnerRuntimeEditor realPresenter;
    ...
    public String getIdentifier() {
        return StunnerRuntimeEditor.EDITOR_ID;
    }
