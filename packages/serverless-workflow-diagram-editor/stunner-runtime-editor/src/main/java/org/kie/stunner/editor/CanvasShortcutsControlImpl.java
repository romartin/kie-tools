...
// TODO: This should be no necessary!

@StunnerRuntimeEditorQualifier
@Dependent
public class CanvasShortcutsControlImpl extends AbstractCanvasShortcutsControlImpl {

    @Inject
    public CanvasShortcutsControlImpl(final @StunnerRuntimeEditorQualifier Instance<KeyboardShortcut> implementedActions) {
