...
@ApplicationScoped
@Named(StunnerJSEditor.EDITOR_ID)
public class StunnerJSEditorActivity extends AbstractActivity implements EditorActivity {

    @Inject
    private StunnerJSEditor realPresenter;
    ...
    public String getIdentifier() {
        return StunnerJSEditor.EDITOR_ID;
    }
