...
public class JsNativeConnectorShapeView extends WiresConnectorViewExt<JsNativeConnectorShapeView> {
    ...
    public JsNativeConnectorShapeView(String color) {
        this(color, DEFAULT_POLYLINE_POINTS);
    }

    public JsNativeConnectorShapeView(String color, final double... points) {
        this(createLine(new PolyLine(points), color));
    }

    private JsNativeConnectorShapeView(final Object[] line) {
