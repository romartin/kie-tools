...
// TODO: Drop?
@Dependent
public class ContainerEditor extends AbstractContainerPopup {
    ...
    @Override
    protected ScrollableLienzoPanel getCanvasPanel() {
        DefaultDiagramEditor de = (DefaultDiagramEditor) editor;
        DefaultDiagramViewer viewer = (DefaultDiagramViewer) de.getViewer();
        return (ScrollableLienzoPanel) viewer.getCanvasPanel();
    }
}
