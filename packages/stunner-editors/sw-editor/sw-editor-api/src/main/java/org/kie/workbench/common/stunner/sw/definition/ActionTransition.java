...
@CanConnect(startRole = EventNode.LABEL_EVENT, endRole = ActionNode.LABEL_ACTION)
@EdgeOccurrences(role = EventNode.LABEL_EVENT, type = EdgeOccurrences.EdgeType.INCOMING, max = 0)
@EdgeOccurrences(role = EventNode.LABEL_EVENT, type = EdgeOccurrences.EdgeType.OUTGOING, max = -1)
