...
import stunnerJSDiagramEditorEnvelopeIndex from "!!raw-loader!../../dist/resources/sjs/stunnerJSDiagramEditorEnvelopeIndex.html";
...
// TODO Custom canvas API - import { BpmnEditorDiagramApi } from "../jsdiagram/BpmnEditorDiagramApi";

declare global {
  interface Window {
    StunnerEditor: Editor;
  }
}
...
const createEnvelopeServer = (iframe: HTMLIFrameElement, readOnly?: boolean, origin?: string) => {
  ...
  // TODO Should be "StunnerJSDiagramEditorEnvelopeApi" instead of "any"?
...
export function open(args: {
  ...
  iframe.srcdoc = stunnerJSDiagramEditorEnvelopeIndex;
