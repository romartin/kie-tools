...
import { StunnerJSDiagramEditorChannelApi } from "./StunnerJSDiagramEditorChannelApi";

/**
 * Class for diagram window interactions.
 */
export class DiagramService implements DiagramExposedInteropApi {
  constructor(private readonly envelopeContext: KogitoEditorEnvelopeContextType<StunnerJSDiagramEditorChannelApi>) {}
