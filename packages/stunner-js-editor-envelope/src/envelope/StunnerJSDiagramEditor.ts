...
export interface StunnerJSDiagramEditor extends GwtEditorWrapper, CanvasConsumedInteropApi {
  myServerlessWorkflowDiagramMethod(): string;
}

export class StunnerJSDiagramEditorImpl extends GwtEditorWrapper implements StunnerJSDiagramEditor {
