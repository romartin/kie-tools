...
import { StunnerJSDiagramEditorChannelApi, StunnerJSDiagramEditorEnvelopeApi } from "../api";
import { StunnerJSDiagramEditor } from "./StunnerJSDiagramEditor";

export type StunnerJSDiagramEnvelopeApiFactoryArgs = EnvelopeApiFactoryArgs<
  StunnerJSDiagramEditorEnvelopeApi,
  StunnerJSDiagramEditorChannelApi,
  EditorEnvelopeViewApi<StunnerJSDiagramEditor>,
  KogitoEditorEnvelopeContextType<StunnerJSDiagramEditorChannelApi>
>;

export class StunnerJSDiagramEditorEnvelopeApiImpl
  extends KogitoEditorEnvelopeApiImpl<
    StunnerJSDiagramEditor,
    StunnerJSDiagramEditorEnvelopeApi,
    StunnerJSDiagramEditorChannelApi
  >
  implements StunnerJSDiagramEditorEnvelopeApi
{
  constructor(
    private readonly serverlessWorkflowArgs: StunnerJSDiagramEnvelopeApiFactoryArgs,
    editorFactory: EditorFactory<StunnerJSDiagramEditor, StunnerJSDiagramEditorChannelApi>
  ) {
